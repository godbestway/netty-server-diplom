...
import version2.interfaces.msgprocessors.perflow.ActionProcessPerflow;
...
public class ActionMsgProcessor extends ActionProcessPerflow {
    ...
    public void receiveActionStatePerflow(ActionStateProto.ActionState actionState) {
        ...
        logger.info("action receive state current time"+System.currentTimeMillis()+" data= "+actionState.getCxid());
