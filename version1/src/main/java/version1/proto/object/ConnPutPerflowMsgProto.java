...
public final class ConnPutPerflowMsgProto {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return ConnPutPerflowMsgProto.internal_static_ConnPutPerflowMsg_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ConnPutPerflowMsgProto.ConnPutPerflowMsg.class, ConnPutPerflowMsgProto.ConnPutPerflowMsg.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ConnPutPerflowMsgProto.ConnPutPerflowMsg)) {
        return super.equals(obj);
      }
      ConnPutPerflowMsgProto.ConnPutPerflowMsg other = (ConnPutPerflowMsgProto.ConnPutPerflowMsg) obj;
    ...
    public static ConnPutPerflowMsgProto.ConnPutPerflowMsg parseFrom(
    ...
    public static ConnPutPerflowMsgProto.ConnPutPerflowMsg parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ConnPutPerflowMsgProto.ConnPutPerflowMsg parseFrom(
    ...
    public static ConnPutPerflowMsgProto.ConnPutPerflowMsg parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ConnPutPerflowMsgProto.ConnPutPerflowMsg parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ConnPutPerflowMsgProto.ConnPutPerflowMsg parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ConnPutPerflowMsgProto.ConnPutPerflowMsg prototype) {
    ...
    public static final class Builder extends
        ...
        ConnPutPerflowMsgProto.ConnPutPerflowMsgOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ConnPutPerflowMsgProto.internal_static_ConnPutPerflowMsg_descriptor;
      }
      ...
      @java.lang.Override
      public ConnPutPerflowMsgProto.ConnPutPerflowMsg getDefaultInstanceForType() {
        return ConnPutPerflowMsgProto.ConnPutPerflowMsg.getDefaultInstance();
      }

      @java.lang.Override
      public ConnPutPerflowMsgProto.ConnPutPerflowMsg build() {
        ConnPutPerflowMsgProto.ConnPutPerflowMsg result = buildPartial();
      ...
      @java.lang.Override
      public ConnPutPerflowMsgProto.ConnPutPerflowMsg buildPartial() {
        ConnPutPerflowMsgProto.ConnPutPerflowMsg result = new ConnPutPerflowMsgProto.ConnPutPerflowMsg(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ConnPutPerflowMsgProto.ConnPutPerflowMsg) {
          return mergeFrom((ConnPutPerflowMsgProto.ConnPutPerflowMsg)other);
        } else {
      ...
      public Builder mergeFrom(ConnPutPerflowMsgProto.ConnPutPerflowMsg other) {
        if (other == ConnPutPerflowMsgProto.ConnPutPerflowMsg.getDefaultInstance()) return this;
        if (other.hasState()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ConnPutPerflowMsgProto.ConnPutPerflowMsg parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ConnPutPerflowMsgProto.ConnPutPerflowMsg) e.getUnfinishedMessage();
    ...
    private static final ConnPutPerflowMsgProto.ConnPutPerflowMsg DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ConnPutPerflowMsgProto.ConnPutPerflowMsg();
    }

    public static ConnPutPerflowMsgProto.ConnPutPerflowMsg getDefaultInstance() {
